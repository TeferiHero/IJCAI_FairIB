...
if __name__ == '__main__':
    try:
        ...
        parser.add_argument('--dataset', type=str, default='./data/gender-bias/process/process.pkl')
        ...
        parser.add_argument('--log_path', type=str, default='logs/ib_bpr_bias_')
        parser.add_argument('--param_path', type=str, default='param/ib_bpr_item_bias_')
